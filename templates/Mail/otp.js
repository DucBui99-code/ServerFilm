module.exports = (name, otp, timeExpired) => {
  return `
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:55px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div style="color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    ...
                                    <p style="font-size: 14px; line-height: 140%;"><span style="color: #000000; line-height: 19.6px;">OTP for verification is <span style="font-weight: 600;">${otp}</span>.</span><br /><br /><span style="color: #000000; line-height: 19.6px;">Note: This OTP is valid for next ${timeExpired} mins.</span></p>
